# Exploring $\color{red}{hello}$ntrinsic $\color{blue}{D}$iscrimination and $\color{green}{C}$onsistency for Weakly Supervised Object Localization (under review)
...
- [ ] A substantially modified version for weakly supervised semantic segmentation task (WSSS).
